...
export const MENU_FALLBACK: MenuItem[] = [
  ...
  m('manana','Desayuno','Vaporcito','Con salsa de tomate.',160,{principal:true,vegano:true,imagen:'/menu/vaporcito.webp'}),
  ...
  m('manana','Bebidas','Jugo de Naranja','',65,{imagen:'/menu/jugo-naranja.webp'}),
  m('manana','Bebidas','Leche con Chocolate','',55,{imagen:'/menu/leche-chocolate.webp'}),
  m('manana','Menú Infantil','Hotcakes de Temayin con fruta','',125,{imagen:'/menu/hotcakes-avena.webp'}),
  m('manana','Menú Vegano','Hotcakes de avena','',120,{vegano:true,imagen:'/menu/hotcakes-avena.webp'}),
  m('manana','Menú Vegano','Avena con fruta','',145,{vegano:true,imagen:'/menu/hotcakes-avena.webp'}),
  ...
  m('tarde','Postres','Gelatina','',45,{imagen:'/menu/gelatina.webp'}),
  m('tarde','Postres','Flan','',95,{imagen:'/menu/flan.webp'}),
  m('tarde','Postres','Galleta con helado','',110,{imagen:'/menu/brownie.webp'}),
  ...
  m('tarde','Bebidas','Vinos','',110,{alcohol:true,imagen:'/menu/vinos.webp'}),
  m('tarde','Bebidas','Licores','',110,{alcohol:true,imagen:'/menu/vinos.webp'}),
];
