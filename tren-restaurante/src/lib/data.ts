...
export const MENU_FALLBACK: MenuItem[] = [
  m('manana','Desayuno','Chilaquiles','Acompañados con frijoles refritos y proteína (pollo).',190,{principal:true}),
  m('manana','Desayuno','Vaporcito','Con salsa de tomate.',160,{principal:true,vegano:true}),
  m('manana','Desayuno','Omelette','De jamón y queso, acompañado con frijoles.',155,{principal:true}),
  ...
  m('manana','Bebidas','Leche con Chocolate','',55),
  m('manana','Menú Infantil','Hotcakes de Temayin con fruta','',125),
  m('manana','Menú Vegano','Hotcakes de avena','',120,{vegano:true}),
  m('manana','Menú Vegano','Avena con fruta','',145,{vegano:true}),
  m('tarde','Comida','Baguette','4 tipos a elegir: Española, Italiana, Tradicional o Premium.',230,{principal:true}),
  m('tarde','Comida','Antojitos Mexicanos','Sopes, pambazos, tostadas y tacos dorados.',145,{principal:true}),
  m('tarde','Comida','Ensaladas','Opción vegana.',145,{principal:true,vegano:true}),
  m('tarde','Botanas','Tabla de charcutería y quesos','',199),
  m('tarde','Botanas','Nachos con frijoles y chorizo de Valladolid','',175),
  m('tarde','Botanas','Guacamole con chorizo de Valladolid y totopos','',150),
  m('tarde','Postres','Churros','',95),
  m('tarde','Postres','Gelatina','',45),
  m('tarde','Postres','Flan','',95),
  m('tarde','Postres','Galleta con helado','',110),
  m('tarde','Postres','Brownie con helado','',110),
  m('tarde','Bebidas','Agua de chaya','',65),
  m('tarde','Bebidas','Refresco','',45),
  m('tarde','Bebidas','Cerveza Tren Maya','',89,{alcohol:true}),
